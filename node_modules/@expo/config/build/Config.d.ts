import { ConfigFilePaths, ExpoConfig, GetConfigOptions, PackageJSONConfig, ProjectConfig, ProjectTarget, WriteConfigOptions } from '@expo/config/build/Config.types';
/**
...
export * from '@expo/config/build/Config.types';
