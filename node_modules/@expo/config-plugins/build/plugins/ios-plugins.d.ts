...
import type { ConfigPlugin, Mod } from '@expo/config-plugins/build/Plugin.types';
import type { ExpoPlist, InfoPlist } from '@expo/config-plugins/build/ios/IosConfig.types';
import type { AppDelegateProjectFile, PodfileProjectFile } from '@expo/config-plugins/build/ios/Paths';
