import { BaseModOptions } from '@expo/config-plugins/build/plugins/withMod';
import { ConfigPlugin, ExportedConfig, ExportedConfigWithProps, ModPlatform } from '@expo/config-plugins/build/Plugin.types';
